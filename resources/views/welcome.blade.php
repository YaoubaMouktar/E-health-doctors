...
<head>
    ...
    <title>E-Health | Tableau de Bord Médecin</title>
...
<body class="font-sans bg-gray-50">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-teal-500 rounded-2xl shadow-xl overflow-hidden mb-8">
                <div class="p-8 md:p-12">
                    <div class="md:flex items-center justify-between">
                        <div class="md:w-2/3">
                            <h1 class="text-3xl md:text-4xl font-bold text-white mb-4">Bienvenue sur E-Health<span class="text-blue-100">Pro</span>, <span class="text-yellow-300">Dr. Jean Martin</span></h1>
    ...
    <!-- Alpine.js pour les fonctionnalités interactives -->
    <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script>
    
    <script>
        // Simple script pour gérer les interactions
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Ajouter des effets d'interactivité supplémentaires
            const actionCards = document.querySelectorAll('.bg-blue-50, .bg-green-50, .bg-purple-50, .bg-red-50, .bg-teal-50, .bg-indigo-50');
